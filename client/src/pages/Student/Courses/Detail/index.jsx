...
const CourseDetail = () => {
  ...
  const course = studentCoursesData.find((c) => c.id === Number.parseInt(id))
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link  className="flex items-center text-muted-foreground hover:text-primary transition-colors">
